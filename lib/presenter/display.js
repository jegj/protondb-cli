...
function updateTable (name, tier, confidence, gameData, table, screen) {
  ...
  if (gameData.requirements) {
    if (gameData?.requirements?.minimum) {
      ...
      generateRequirementsEntries(gameData?.requirements?.minimum, data)
    }
    ...
    if (gameData?.requirements?.recommended) {
      ...
      generateRequirementsEntries(gameData?.requirements?.recommended, data)
    }
  }
...
function generateRequirementsEntries (requirements, data) {
