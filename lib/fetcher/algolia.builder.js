...
*/
export const buildBodyRequest = function _buildBodyRequest ({ query, hitsPerPage }) {
...
/**
{
  ...
  "x-algolia-api-key": "xxxxxxx",
  "x-algolia-application-id": "xxxxx",
}
*/
export const buildHeaderRequest = function _builddHeaderRequest (headers) {
